...
| `docs/architecture/block-overlay-lifecycle.md` | Overlay lifecycle invariant (#8), the walk-away path, the daily 2-minute pass, hold-to-unlock (#35) | editing `ui/overlay/`, `RecordWalkAwayUseCase`, `HoldToUnlock`, `EmergencyPass*` |
